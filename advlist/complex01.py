...
def main():
    ...
    # create a list of at least five animals with three letter names
    _3_letter_animals = [ 'ant', 'bee', 'cat', 'dog', 'fox' ]

    # print the list of three letter animals
    print(_3_letter_animals)
